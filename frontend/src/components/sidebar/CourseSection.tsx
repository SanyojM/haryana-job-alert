    ...
    <section className="bg-gray-100 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
          {courses.map((course) => (
            <div key={course.id} className="bg-white p-2 rounded-2xl overflow-hidden flex flex-col">
              ...
              <div className="py-5 px-1 flex flex-col flex-grow">
        ...
        <div className="text-center mt-12">
          <button className="bg-gray-100 border-2 border-gray-300 rounded-xl px-18 py-3 font-semibold text-gray-800 hover:bg-gray-100 hover:border-gray-400 transition-all shadow-sm">
            View More
          </button>
        </div>
      </div>

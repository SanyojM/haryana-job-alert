...
const documentsData = {
  title: 'Documents',
  description: 'These are links for Documents',
  color: 'from-red-500 to-red-800',
  links: [
...
const admissionsData = {
  title: 'Admissions',
  description: 'These are links for Admissions',
  color: 'from-red-500 to-red-800',
  links: [
...
const MidCard = ({ data }: { data: typeof answerKeysData }) => (
    ...
    <section className="bg-gray-100 py-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <MidCard data={answerKeysData} />
          <MidCard data={documentsData} />
          <AdBanner text="Google Ads Section" className="h-24 md:hidden" />
          <MidCard data={admissionsData} />
        </div>
      </div>
    </section>
  );

  ...
  return (
    <div className="container mx-auto p-4">
          ...
          <form onSubmit={handleCreate}>
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button type="submit" disabled={isLoading} className="w-full">{isLoading ? 'Saving...' : 'Save Tag'}</Button>
              </CardContent>
            </Card>
          </form>
        </div>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader><DialogTitle>Edit Mock Tag</DialogTitle></DialogHeader>
          {editingTag && (
